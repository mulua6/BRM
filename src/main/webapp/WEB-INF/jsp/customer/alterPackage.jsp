...
<!--显示表单内容-->
<div id=MainArea>
    <form action="${pageContext.request.contextPath}/customerAction/alterPackage.action" method="post">
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td>名字</td>
                        <td>
                            ...
                            <input type="text" name="customerName" value="${customer.customerName}" readonly cssClass="InputStyle"/>
                        </td>
                    </tr>
                    <tr><td>套餐</td>
                        <td>
                    ...
                    <%--<tr><td>应补套餐费</td>--%>
                        <%--<td>--%>
                            <%--<input type="text" name="number" value="${customer.number}" readonly cssClass="InputStyle"/>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <%--<tr><td>应补押金</td>--%>
                        <%--<td>--%>
                            <%--<input type="text" name="phone" value="${customer.phone}" readonly cssClass="InputStyle"/>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <tr><td>备注</td>
                        <td>
