...
<html>
  ...
  <div id="Title_bar_Head"> 
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/css/images/title_arrow.gif"/> 书架管理
        </div>
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="userList">
            ...
            <c:forEach items="${shelfList}" var="shelf" varStatus="s">

                <tr class="TableDetail1 template">
                    <td align="center" style="text-align: center">${shelf.number}</td>
                    <td align="center" style="text-align: center">${shelf.shelfName}&nbsp;</td>
                    <td><a href="${pageContext.request.contextPath}/shelfAction/deleteShelf.action?id=${shelf.id}">删除</a> |
                        <a href="${pageContext.request.contextPath}/shelfAction/preUpdateShelf.action?id=${shelf.id}">修改</a>
                    </td>
                </tr>
       ...
       <div id="TableTail">
        <div id="TableTail_inside">
            <a href="${pageContext.request.contextPath}/go.action?to=shelf/add"><img src="${pageContext.request.contextPath}/css/images/createNew.png" /></a>
        </div>
    </div>
