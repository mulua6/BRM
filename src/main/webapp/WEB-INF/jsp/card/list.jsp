    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <thead>
            <tr align=center valign=middle id=TableTitle>
                ...
                <td width="100">收费金额</td>
                <td width="100">可借书数量</td>
                <td width="100">押金金额</td>
                <td width="100">丢失罚金</td>
                <td width="100">损坏罚金</td>
                <td>相关操作</td>
            </tr>
        </thead>
        ...
        <tbody id="TableData" class="dataContainer" datakey="userList">
            ...
            <c:forEach items="${cardList}" var="card" varStatus="s">

                <tr class="TableDetail1 template">
                    <td align="center" style="text-align: center">${s.count}</td>
                    <td align="center" style="text-align: center">${card.cardName}</td>
                    <td align="center" style="text-align: center">${card.price}</td>
                    <td align="center" style="text-align: center">${card.number}</td>
                    <td align="center" style="text-align: center">${card.deposit}</td>
                    <td align="center" style="text-align: center">${card.lost}</td>
                    <td align="center" style="text-align: center">${card.broken}&nbsp;</td>
                    <td><a href="${pageContext.request.contextPath}/cardAction/deleteCard.action?id=${card.id}">删除</a> |
                        <a href="${pageContext.request.contextPath}/cardAction/preUpdateCard.action?id=${card.id}">修改</a>
                    </td>
                </tr>
       ...
       <div id="TableTail">
        <div id="TableTail_inside">
            <a href="${pageContext.request.contextPath}/go.action?to=card/add"><img src="${pageContext.request.contextPath}/css/images/createNew.png" /></a>
        </div>
    </div>
