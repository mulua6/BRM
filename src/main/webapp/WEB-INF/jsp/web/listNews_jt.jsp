...
<s:iterator value="%{newsList}"  id = "c"  var="news"  status = "s">
           <ul class="newslist">
           <li class="newslist_diy"><div class="time"><s:property value ="%{#news.createTime}"/></div><s:a action="webAction_findOneNews_jt?id=%{#news.id}" target="_self" class="newslist_diy"><s:property value ="%{#news.title}"/></s:a></li>
           </ul>
	</s:iterator>
